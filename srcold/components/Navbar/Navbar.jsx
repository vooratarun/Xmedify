import { Box, Container, Button, List, ListItem, Stack, Typography, useMediaQuery, IconButton } from "@mui/material";
    ...
    return (
        <header>
            <Box p={1} bgcolor="primary.main">
                <Typography fontSize={{ xs: 8, sm: 14 }} textAlign="center" color="#fff">
